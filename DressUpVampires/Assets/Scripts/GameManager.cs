    ...
    public void ResetTagsAndSlots()
    {
        switch (masqueradeCounter)
        {
            ...
            case 1:
                ...
                invitationText.text = "With respect we invite you to the Royal Masqurade as hosted by Countess Ramona Renfield. We ask you to dress to the occasion.\r\nNote:\r\nOur countess is looking for well tailored suits that do not shy away from a great amounts of fabric, including but not limited to ruffles.";
                masqueradeCounter++;
                difficultyScale = 2;
                break;
            ...
            case 2:
                ...
                if(hint1 & !hint2)
                {
                    invitationText.text = "With utmost respect we invite you to the Skin Masquerade, lovingly hosted by the feared Lord Relyn Von Valtien. We ask you to dress to the occasion.\r\nNote:\r\nA person should feel comfort in their own skin. Tonight you may show just how comfortable you are… \r\n The host enjoys…" + storeHint1;
                }
                else if(!hint1 & hint2)
                {
